...
int FEAT_SKILL_FOCUS_APPRAISE			   = FEAT_SKILLFOCUS_APPRAISE;
...
int IP_CONST_MATERIAL_UNKNOWN					 = 0;
int IP_CONST_MATERIAL_ADAMANTINE				 = 1;
int IP_CONST_MATERIAL_BRASS						 = 2;
int IP_CONST_MATERIAL_BRONZE					 = 3;
int IP_CONST_MATERIAL_CARBON					 = 4;
int IP_CONST_MATERIAL_COLD_IRON					 = 5;
int IP_CONST_MATERIAL_COPPER					 = 6;
int IP_CONST_MATERIAL_DARKSTEEL					 = 7;
int IP_CONST_MATERIAL_GOLD						 = 8;
int IP_CONST_MATERIAL_IRON						 = 9;
int IP_CONST_MATERIAL_LEAD						 = 10;
int IP_CONST_MATERIAL_MITHRAL					 = 11;
int IP_CONST_MATERIAL_PLATINUM					 = 12;
int IP_CONST_MATERIAL_SILVER					 = 13;
int IP_CONST_MATERIAL_SILVER_ALCHEMICAL			 = 14;
int IP_CONST_MATERIAL_STEEL						 = 15;
int IP_CONST_MATERIAL_BONE						 = 16;
int IP_CONST_MATERIAL_HIDE						 = 17;
int IP_CONST_MATERIAL_HIDE_SALAMANDER			 = 18;
int IP_CONST_MATERIAL_HIDE_UMBER_HULK			 = 19;
int IP_CONST_MATERIAL_HIDE_WYVERN				 = 20;
int IP_CONST_MATERIAL_HIDE_DRAGON_BLACK			 = 21;
int IP_CONST_MATERIAL_HIDE_DRAGON_BLUE			 = 22;
int IP_CONST_MATERIAL_HIDE_DRAGON_BRASS			 = 23;
int IP_CONST_MATERIAL_HIDE_DRAGON_BRONZE		 = 24;
int IP_CONST_MATERIAL_HIDE_DRAGON_COPPER		 = 25;
int IP_CONST_MATERIAL_HIDE_DRAGON_GOLD			 = 26;
int IP_CONST_MATERIAL_HIDE_DRAGON_GREEN			 = 27;
int IP_CONST_MATERIAL_HIDE_DRAGON_RED			 = 28;
int IP_CONST_MATERIAL_HIDE_DRAGON_SILVER		 = 29;
int IP_CONST_MATERIAL_HIDE_DRAGON_WHITE			 = 30;
int IP_CONST_MATERIAL_LEATHER					 = 31;
int IP_CONST_MATERIAL_SCALE						 = 32;
int IP_CONST_MATERIAL_CLOTH						 = 33;
int IP_CONST_MATERIAL_COTTON					 = 34;
int IP_CONST_MATERIAL_SILK						 = 35;
int IP_CONST_MATERIAL_WOOL						 = 36;
int IP_CONST_MATERIAL_WOOD						 = 37;
int IP_CONST_MATERIAL_WOOD_IRONWOOD				 = 38;
int IP_CONST_MATERIAL_WOOD_DUSKWOOD				 = 39;
int IP_CONST_MATERIAL_WOOD_DARKWOOD_ZALANTAR	 = 40;
int IP_CONST_MATERIAL_WOOD_ASH					 = 41;
int IP_CONST_MATERIAL_WOOD_YEW					 = 42;
int IP_CONST_MATERIAL_WOOD_OAK					 = 43;
int IP_CONST_MATERIAL_WOOD_PINE					 = 44;
int IP_CONST_MATERIAL_WOOD_CEDAR				 = 45;
int IP_CONST_MATERIAL_ELEMENTAL					 = 46;
int IP_CONST_MATERIAL_ELEMENTAL_AIR				 = 47;
int IP_CONST_MATERIAL_ELEMENTAL_EARTH			 = 48;
int IP_CONST_MATERIAL_ELEMENTAL_FIRE			 = 49;
int IP_CONST_MATERIAL_ELEMENTAL_WATER			 = 50;
int IP_CONST_MATERIAL_GEM						 = 51;
int IP_CONST_MATERIAL_GEM_ALEXANDRITE			 = 52;
int IP_CONST_MATERIAL_GEM_AMETHYST				 = 53;
int IP_CONST_MATERIAL_GEM_AVENTURINE			 = 54;
int IP_CONST_MATERIAL_GEM_BELJURIL				 = 55;
int IP_CONST_MATERIAL_GEM_BLOODSTONE			 = 56;
int IP_CONST_MATERIAL_GEM_BLUE_DIAMOND			 = 57;
int IP_CONST_MATERIAL_GEM_CANARY_DIAMOND		 = 58;
int IP_CONST_MATERIAL_GEM_DIAMOND				 = 59;
int IP_CONST_MATERIAL_GEM_EMERALD				 = 60;
int IP_CONST_MATERIAL_GEM_FIRE_AGATE			 = 61;
int IP_CONST_MATERIAL_GEM_FIRE_OPAL				 = 62;
int IP_CONST_MATERIAL_GEM_FLOURSPAR				 = 63;
int IP_CONST_MATERIAL_GEM_GARNET				 = 64;
int IP_CONST_MATERIAL_GEM_GREENSTONE			 = 65;
int IP_CONST_MATERIAL_GEM_JACINTH				 = 66;
int IP_CONST_MATERIAL_GEM_KINGS_TEAR			 = 67;
int IP_CONST_MATERIAL_GEM_MALACHITE				 = 68;
int IP_CONST_MATERIAL_GEM_OBSIDIAN				 = 69;
int IP_CONST_MATERIAL_GEM_PHENALOPE				 = 70;
int IP_CONST_MATERIAL_GEM_ROGUE_STONE			 = 71;
int IP_CONST_MATERIAL_GEM_RUBY					 = 72;
int IP_CONST_MATERIAL_GEM_SAPPHIRE				 = 73;
int IP_CONST_MATERIAL_GEM_STAR_SAPPHIRE			 = 74;
int IP_CONST_MATERIAL_GEM_TOPAZ					 = 75;
int IP_CONST_MATERIAL_GEM_CRYSTAL_DEEP			 = 76;
int IP_CONST_MATERIAL_GEM_CRYSTAL_MUNDANE		 = 77;
