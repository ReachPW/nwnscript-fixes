...
void SetModuleOverrideSpellscript(string sScriptName) { SetLocalString(GetModule(), MODULE_VAR_OVERRIDE_SPELLSCRIPT, sScriptName); }
...
//------------------------------------------------------------------------------
void SetModuleOverrideSpellScriptFinished() { SetLocalInt(OBJECT_SELF, "X2_L_BLOCK_LAST_SPELL", TRUE); }
...
void SetCreatureOverrideAIScript(object oCreature, string sScriptName) { SetLocalString(oCreature, CREATURE_VAR_CUSTOM_AISCRIPT, sScriptName); }
...
void ClearCreatureOverrideAIScriptTarget(object oCreature = OBJECT_SELF) { DeleteLocalObject(oCreature, "X2_NW_I0_GENERIC_INTRUDER"); }
...
// X2_ITEM_EVENT_SPELLCAST_AT
//----------------------------------------------------------------------------
int GetUserDefinedItemEventNumber() { return GetLocalInt(OBJECT_SELF, "X2_L_LAST_ITEM_EVENT"); }
...
// X2_ITEM_EVENT_SPELLCAST_AT
//----------------------------------------------------------------------------
void SetUserDefinedItemEventNumber(int nEvent) { SetLocalInt(OBJECT_SELF, "X2_L_LAST_ITEM_EVENT", nEvent); }
...
// local vault server
//----------------------------------------------------------------------------
void SetUserDefinedItemEventPrefix(string sPrefix = "") { SetLocalString(GetModule(), "MODULE_VAR_TAGBASED_SCRIPT_PREFIX", sPrefix); }
...
//----------------------------------------------------------------------------
void SetExecutedScriptReturnValue(int nValue = X2_EXECUTE_SCRIPT_END) { SetLocalInt(OBJECT_SELF, "X2_L_LAST_RETVAR", nValue); }

//----------------------------------------------------------------------------
// Define the name of the 2da file which is used for the wandering monster
// system
//----------------------------------------------------------------------------
void SetWanderingMonster2DAFile(string s2DAName = "des_restsystem") { SetLocalString(OBJECT_SELF, MODULE_VAR_WANDERING_MONSTER_2DA, s2DAName); }
